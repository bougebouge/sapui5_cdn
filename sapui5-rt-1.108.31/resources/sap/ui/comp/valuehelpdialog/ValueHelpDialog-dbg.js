...
sap.ui.define([
	...
	ValueHelpDialog.prototype.update = function() {
		...
		var oRows = this._oTable && this._oTable.getBinding("rows");

		if (oRows) {
			oRows.attachEventOnce("dataReceived", function() {
				var iLength = oRows.getLength(),
					nRowCount = this._oNumberFormatInstance && this._oNumberFormatInstance.format(iLength) || iLength;
