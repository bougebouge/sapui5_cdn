...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.shell.Settings.UserSettings", {
         ...
         * so the update is executed only once when preperation phase is over.
         * It bundles the requests concerning the user preferences into a batch.
         * It rejects when one update fails. That means subscribers have to check error mesasge if they are concerned.
        ...
        _executeEntrySave: function (oEntry) {
            ...
            try {
                ...
                this._isExececuteEntrySavedInUserSettingsController = true;
