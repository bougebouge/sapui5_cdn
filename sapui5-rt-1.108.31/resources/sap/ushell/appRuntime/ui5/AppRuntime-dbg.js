...
sap.ui.define([
    ...
    function AppRuntime () {
                            ...
                            sap.ushell.Container.getServiceAsync("AppLifeCycle").then(function (oAppLifeCycleService) {
                                ...
                                try {
                                    var oMetaData = oResolutionResultWithComponentHandle.componentHandle.getMetadata(),
                                        sAppVersion = oMetaData.getVersion();
                                    _that.getCurrentAppInfo(oAppLifeCycleService, oURLParameters, sAppVersion);
                                } catch (error) {
                                    //do nothing
                                }
                            });
         ...
         * @private
         */
        this.getCurrentAppInfo = function (oAppLifeCycleService, oURLParameters, sAppVersion) {

            var oCurrentApp = oAppLifeCycleService.getCurrentApplication(),
                oAppInfo = {};

            oAppInfo.appVersion = sAppVersion;
            Promise.all([
        ...
        this.renderApplication = function (oCreateApplicationResult) {
            ...
            AppLifeCycleAgent.setComponent(oCreateApplicationResult.oComponentContainer, oCreateApplicationResult.ui5ComponentName);
        };
    }
