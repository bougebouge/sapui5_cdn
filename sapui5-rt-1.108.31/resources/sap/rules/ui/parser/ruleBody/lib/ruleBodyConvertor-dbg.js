sap.ui.define([
	...
	"sap/rules/ui/parser/AST/lib/bundleAst"
], function(ruleBodyValidatorLib, constants, parserConstants, utilsBase, valueHelpValidatorLib,
		decisionTableCellLib, ASTConvertorLib, ) {
    "use strict";
    
    var bundleApi = RulesAPI_Ast;
	var ASTOperationsLib = bundleApi.astOperations;
	var utilsBaseLib = new utilsBase.utilsBaseLib();
