...
export class NavigationService extends Service<NavigationServiceSettings> {
	 ...
	 *          returned
	 */
	storeInnerAppStateAsync(mInnerAppData: any, bImmediateHashReplace?: boolean | undefined, bSkipHashReplace?: boolean | undefined) {
	...
	mixAttributesAndSelectionVariant(
		...
		sSelectionVariant: string | SelectionVariant,
