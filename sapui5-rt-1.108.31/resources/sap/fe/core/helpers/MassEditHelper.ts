...
import { FieldSideEffectPropertyType, MassEditFieldSideEffectPropertyType } from "sap/fe/core/controllerextensions/SideEffects";
import {
...
import type { ODataSideEffectsType, SideEffectsType } from "sap/fe/core/services/SideEffectsServiceFactory";
...
type DataToUpdateFieldAndSideEffectsType = {
	oController: any;
	oFieldPromise: Promise<any>;
	sideEffectsMap: MassEditFieldSideEffectPropertyType | FieldSideEffectPropertyType;
	textPaths: any;
	groupId: string;
	key: string;
	oEntitySetContext: any;
	oMetaModel: any;
...
const MassEditHelper = {
	 ...
	 */
	getSideEffectDataForKey: function (oEntitySetContext: any, aSideEffects: any, oController: any, aResults: any) {
