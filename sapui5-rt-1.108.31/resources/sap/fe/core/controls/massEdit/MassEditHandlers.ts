...
import ValueListHelper, { ValueHelpPayload, ValueListInfo } from "sap/fe/macros/internal/valuehelp/ValueListHelperNew";
...
const MassEditHandlers: any = {
	...
	_requestValueList: function (transCtx: Context, source: Field, fieldInfoModel: JSONModel, propertyName: string): void {
		...
		const metaModel = transCtx.getModel().getMetaModel() as ODataMetaModel;
