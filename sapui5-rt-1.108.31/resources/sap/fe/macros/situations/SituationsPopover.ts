...
function createListPopover(controller: Controller, expectedNumberOfSituations: number) {
...
async function createPreviewPopover(controller: Controller, back?: (event: UI5Event) => void) {
...
export async function showPopover(controller: Controller, event: UI5Event, situationsNavigationProperty: string) {
