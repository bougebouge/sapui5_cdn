...
//import { getPressExpressionForEdit } from "sap/fe/templates/ObjectPage/ObjectPageTemplating";
import * as OP from "sap/fe/templates/ObjectPage/ObjectPageTemplating";
				...
				switch (oAction.defaultAction.type) {
					case "ForAction": {
						if (mode === "Table") {
							...
							return OP.getPressExpressionForEdit(
								oDataFieldForDefaultAction,
								defaultActionContextOrEntitySet,
								oAction.defaultAction
							);
						}
						return undefined;
					}
