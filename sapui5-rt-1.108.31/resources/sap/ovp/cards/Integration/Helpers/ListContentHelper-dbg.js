        ...
        if (oCardDefinition && oCardDefinition.itemBindingInfo) {
            ...
            if (oFirstStatus) {
                aItemAttributes.push({
                    ...
                    state: ContentHelper.getBindingPathOrValue(oFirstStatus, "state", false, oCardDefinition.parameters) || 'None'
                });
            }
            // Attribute 2
            ...
            if (oSecondStatus) {
                aItemAttributes.push({
                    ...
                    state: ContentHelper.getBindingPathOrValue(oSecondStatus, "state", false, oCardDefinition.parameters) || 'None'
                });
            }
        }
