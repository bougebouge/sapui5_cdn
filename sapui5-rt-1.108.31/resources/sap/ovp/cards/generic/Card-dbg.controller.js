sap.ui.define([
    ...
    return Controller.extend("sap.ovp.cards.generic.Card", {
        ...
        onAfterRendering: function () {
            ...
            var bNavigationExistsForCard = false;
            ...
            if (bIsNavigable) {
                ...
                if (sContentFragment) {
                    ...
                    } else if (bIsLineItemNavigable && 
                        (sContentFragment === "sap.ovp.cards.list.List" || sContentFragment === "sap.ovp.cards.table.Table")) {
                        bNavigationExistsForCard = true;
                    }

                    if (sContentFragment === "sap.ovp.cards.charts.analytical.analyticalChart" && this.checkNavigation()) {
                        bNavigationExistsForCard = true;
                    }
                }
            }

            if (!bNavigationExistsForCard) {
                var oMyInsightButton = this.getView().byId("sapOvpCardInsights");

                if (oMyInsightButton && oMyInsightButton.getVisible()) {
                    oMyInsightButton.setVisible(false);
                }
            }
        ...
        onHeaderClick: function (oEvent) {
            ...
            if (sTargetId && sTargetId.indexOf("sapOvpCardInsights") > -1) {
                return;
            }
        ...
        */
        ...
        /**
         * open popover to show additional actions on card header
         ...
         */
         onShowAdditionalCardActions: function (oEvent) {
            ...
            if (!this.additionalCardActionsPopover) {
				this.additionalCardActionsPopover = Fragment.load({
			...
			this.additionalCardActionsPopover.then(function(oPopover) {
