sap.ui.define([
    ...
    return ControllerExtension.extend("sap.ovp.app.TemplateBaseExtension", {
         ...
         * @param {sap.ui.generic.app.navigation.service.SelectionVariant} oCustomSelectionVariant reference to the custom selection variant expected by OVP library
         * @protected
         */
