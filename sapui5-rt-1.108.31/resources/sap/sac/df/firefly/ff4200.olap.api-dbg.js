...
oFF.AnalyticTableExportHelperFactory = {
	...
	createTableExportHelper:function(analyticsTable)
	{
			return oFF.AnalyticTableExportHelperFactory.s_factory.newTableExportHelper(analyticsTable);
	}
};
...
oFF.QTimeMemberNavigationGenerator.createParallelPeriodMemberNavigation = function(context, levelValue, constantValue)
{
	var memberNav;
...
oFF.QTimeMemberNavigationGenerator.generateOffsetRange = function(queryModel, levelName, lookBack, lookAhead, offsetFunction, offsetLevelName, offsetAmount)
{
	var offsetMemberNav = oFF.QTimeMemberNavigationGenerator.generateOffsetMemberNav(queryModel, offsetFunction, offsetLevelName, offsetAmount);
...
oFF.QTimeMemberNavigationGenerator.generateOpeningPeriodToClosingPeriodOffsetRange = function(timeDimension, hierarchyName, levelName)
{
	var leveledHierarchy = timeDimension.getLeveledHierarchy(hierarchyName);
	var topLevel = leveledHierarchy.getMostCoarseLevel();
	var level = leveledHierarchy.getLevelByName(levelName);
...
oFF.QTimeMemberNavigationGenerator.generateOffsetRangeToCurrentPeriod = function(queryModel, levelName, lookBack, offsetFunction, offsetLevelName, offsetAmount)
{
	return oFF.QTimeMemberNavigationGenerator.generateOffsetRange(queryModel, levelName, lookBack, 0, offsetFunction, offsetLevelName, offsetAmount);
};
oFF.QTimeMemberNavigationGenerator.generateMostGranularLevelToDateRange = function(queryModel, timeDimension, hierarchyName, toDateLevel, lookBack, offsetFunction, offsetLevelName, offsetAmount)
{
	var memberNavigations = oFF.XList.create();
	var offsetMemberNav = oFF.QTimeMemberNavigationGenerator.generateOffsetMemberNav(queryModel, offsetFunction, offsetLevelName, offsetAmount);
	if (oFF.notNull(offsetMemberNav))
	...
	var ancestor = oFF.QFactory.createMemberNavigation(oFF.CurrentMemberFunction.ANCESTOR);
	ancestor.addParameter(oFF.QFactory.createNavigationParameterWithLevelLiteral(toDateLevel));
	memberNavigations.add(ancestor);
	var leveledHierarchy = timeDimension.getLeveledHierarchy(hierarchyName);
	if (oFF.notNull(leveledHierarchy))
	{
		var lowestLevel = leveledHierarchy.getMostGranularLevel();
		var level = leveledHierarchy.getLevelByName(toDateLevel);
		if (oFF.isNull(level))
		{
			throw oFF.XException.createRuntimeException("Input level not found in time dimension.");
		}
		var distance = lowestLevel.getLevelNumber() - level.getLevelNumber();
		if (distance === 0)
		{
			throw oFF.XException.createRuntimeException("Input level cannot be the lowest level.");
		}
		...
		if (lookBack !== 0)
		{
			memberNavigations.add(oFF.QTimeMemberNavigationGenerator.createParallelPeriodMemberNavigation(queryModel, toDateLevel, lookBack));
		}
		var rangeNav = oFF.QFactory.createMemberNavigation(oFF.CurrentMemberFunction.RANGE);
		if (oFF.notNull(offsetMemberNav))
		{
	...
	{
		throw oFF.XException.createRuntimeException("leveledHierarchy is null.");
	}
	return memberNavigations;
};
oFF.QTimeMemberNavigationGenerator.generateOffsetMemberNav = function(queryModel, offsetFunction, offsetLevelName, offsetAmount)
{
	...
	if (oFF.notNull(offsetFunction) && oFF.XStringUtils.isNotNullAndNotEmpty(offsetLevelName) && offsetAmount > 0)
	{
		...
		offsetMemberNav = oFF.QTimeMemberNavigationGenerator.createParallelPeriodMemberNavigation(queryModel, offsetLevelName, offsetValue);
	}
...
oFF.CellFormattingScope = function() {};
oFF.CellFormattingScope.prototype = new oFF.XConstant();
oFF.CellFormattingScope.prototype._ff_c = "CellFormattingScope";

oFF.CellFormattingScope.s_instances = null;
oFF.CellFormattingScope.AFFECTED_CELLS = null;
oFF.CellFormattingScope.HEADER_CELLS = null;
oFF.CellFormattingScope.HEADER_CELLS_FIRST = null;
oFF.CellFormattingScope.HEADER_CELLS_LAST = null;
oFF.CellFormattingScope.HEADER_CELLS_ROW_FIRST = null;
oFF.CellFormattingScope.HEADER_CELLS_ROW_LAST = null;
oFF.CellFormattingScope.HEADER_CELLS_COLUMN_FIRST = null;
oFF.CellFormattingScope.HEADER_CELLS_COLUMN_LAST = null;
oFF.CellFormattingScope.HEADER_CELLS_ROW = null;
oFF.CellFormattingScope.HEADER_CELLS_COLUMN = null;
oFF.CellFormattingScope.DATA_CELLS = null;
oFF.CellFormattingScope.DATA_CELLS_FIRST = null;
oFF.CellFormattingScope.DATA_CELLS_LAST = null;
oFF.CellFormattingScope.DATA_CELLS_ROW_FIRST = null;
oFF.CellFormattingScope.DATA_CELLS_ROW_LAST = null;
oFF.CellFormattingScope.DATA_CELLS_COLUMN_FIRST = null;
oFF.CellFormattingScope.DATA_CELLS_COLUMN_LAST = null;
oFF.CellFormattingScope.DATA_CELLS_ROW = null;
oFF.CellFormattingScope.DATA_CELLS_COLUMN = null;
oFF.CellFormattingScope.ALL_CELLS = null;
oFF.CellFormattingScope.ALL_CELLS_ROW = null;
oFF.CellFormattingScope.ALL_CELLS_COLUMN = null;
oFF.CellFormattingScope.staticSetup = function()
{
	oFF.CellFormattingScope.s_instances = oFF.XHashMapByString.create();
	oFF.CellFormattingScope.AFFECTED_CELLS = oFF.CellFormattingScope.create("AffectedCells", false, false, false, false, false, false);
	oFF.CellFormattingScope.HEADER_CELLS = oFF.CellFormattingScope.create("HeaderCells", false, false, true, false, false, false);
	oFF.CellFormattingScope.HEADER_CELLS_FIRST = oFF.CellFormattingScope.create("HeaderCellsFirst", true, false, true, false, false, false);
	oFF.CellFormattingScope.HEADER_CELLS_LAST = oFF.CellFormattingScope.create("HeaderCellsLast", false, true, true, false, false, false);
	oFF.CellFormattingScope.HEADER_CELLS_ROW_FIRST = oFF.CellFormattingScope.create("HeaderCellsRowFirst", true, false, true, false, true, false);
	oFF.CellFormattingScope.HEADER_CELLS_ROW_LAST = oFF.CellFormattingScope.create("HeaderCellsRowLast", false, true, true, false, true, false);
	oFF.CellFormattingScope.HEADER_CELLS_COLUMN_FIRST = oFF.CellFormattingScope.create("HeaderCellsColumnFirst", true, false, true, false, false, true);
	oFF.CellFormattingScope.HEADER_CELLS_COLUMN_LAST = oFF.CellFormattingScope.create("HeaderCellsColumnLast", false, true, true, false, false, true);
	oFF.CellFormattingScope.HEADER_CELLS_ROW = oFF.CellFormattingScope.create("HeaderCellsRow", false, false, true, false, true, false);
	oFF.CellFormattingScope.HEADER_CELLS_COLUMN = oFF.CellFormattingScope.create("HeaderCellsColumn", false, false, true, false, false, true);
	oFF.CellFormattingScope.DATA_CELLS = oFF.CellFormattingScope.create("DataCells", false, false, false, true, false, false);
	oFF.CellFormattingScope.DATA_CELLS_FIRST = oFF.CellFormattingScope.create("DataCellsFirst", true, false, false, true, false, false);
	oFF.CellFormattingScope.DATA_CELLS_LAST = oFF.CellFormattingScope.create("DataCellsLast", false, true, false, true, false, false);
	oFF.CellFormattingScope.DATA_CELLS_ROW_FIRST = oFF.CellFormattingScope.create("DataCellsRowFirst", true, false, false, true, true, false);
	oFF.CellFormattingScope.DATA_CELLS_ROW_LAST = oFF.CellFormattingScope.create("DataCellsRowLast", false, true, false, true, true, false);
	oFF.CellFormattingScope.DATA_CELLS_COLUMN_FIRST = oFF.CellFormattingScope.create("DataCellsColumnFirst", true, false, false, true, false, true);
	oFF.CellFormattingScope.DATA_CELLS_COLUMN_LAST = oFF.CellFormattingScope.create("DataCellsColumnLast", false, true, false, true, false, true);
	oFF.CellFormattingScope.DATA_CELLS_ROW = oFF.CellFormattingScope.create("DataCellsRow", false, false, false, true, true, false);
	oFF.CellFormattingScope.DATA_CELLS_COLUMN = oFF.CellFormattingScope.create("DataCellsColumn", false, false, false, true, false, true);
	oFF.CellFormattingScope.ALL_CELLS = oFF.CellFormattingScope.create("AllCells", false, false, false, false, false, false);
	oFF.CellFormattingScope.ALL_CELLS_ROW = oFF.CellFormattingScope.create("AllCellsRow", false, false, false, false, true, false);
	oFF.CellFormattingScope.ALL_CELLS_COLUMN = oFF.CellFormattingScope.create("AllCellsColumn", false, false, false, false, false, true);
};
oFF.CellFormattingScope.create = function(name, first, last, header, data, rows, columns)
{
	var object = oFF.XConstant.setupName(new oFF.CellFormattingScope(), name);
	object.m_restrictToFirst = first;
	object.m_restrictToLast = last;
	object.m_restrictToHeaders = header;
	object.m_restrictToData = data;
	object.m_restrictToRows = rows;
	object.m_restrictToColumns = columns;
	oFF.CellFormattingScope.s_instances.put(name, object);
	return object;
};
oFF.CellFormattingScope.lookup = function(name)
{
	return oFF.CellFormattingScope.s_instances.getByKey(name);
};
oFF.CellFormattingScope.prototype.m_restrictToFirst = false;
oFF.CellFormattingScope.prototype.m_restrictToLast = false;
oFF.CellFormattingScope.prototype.m_restrictToHeaders = false;
oFF.CellFormattingScope.prototype.m_restrictToData = false;
oFF.CellFormattingScope.prototype.m_restrictToRows = false;
oFF.CellFormattingScope.prototype.m_restrictToColumns = false;
oFF.CellFormattingScope.prototype.isRestrictToFirst = function()
{
	return this.m_restrictToFirst;
};
oFF.CellFormattingScope.prototype.setRestrictToFirst = function(restrictToFirst)
{
	this.m_restrictToFirst = restrictToFirst;
};
oFF.CellFormattingScope.prototype.isRestrictToLast = function()
{
	return this.m_restrictToLast;
};
oFF.CellFormattingScope.prototype.setRestrictToLast = function(restrictToLast)
{
	this.m_restrictToLast = restrictToLast;
};
oFF.CellFormattingScope.prototype.isRestrictToHeaders = function()
{
	return this.m_restrictToHeaders;
};
oFF.CellFormattingScope.prototype.setRestrictToHeaders = function(restrictToHeaders)
{
	this.m_restrictToHeaders = restrictToHeaders;
};
oFF.CellFormattingScope.prototype.isRestrictToData = function()
{
	return this.m_restrictToData;
};
oFF.CellFormattingScope.prototype.setRestrictToData = function(restrictToData)
{
	this.m_restrictToData = restrictToData;
};
oFF.CellFormattingScope.prototype.isRestrictToRows = function()
{
	return this.m_restrictToRows;
};
oFF.CellFormattingScope.prototype.isApplicableToAxis = function(axisType)
{
	if (axisType === oFF.AxisType.ROWS)
	{
		return !this.m_restrictToColumns;
	}
...
oFF.CellFormattingScope.prototype.setRestrictToRows = function(restrictToRows)
{
	this.m_restrictToRows = restrictToRows;
};
oFF.CellFormattingScope.prototype.isRestrictToColumns = function()
{
	return this.m_restrictToColumns;
};
oFF.CellFormattingScope.prototype.setRestrictToColumns = function(restrictToColumns)
{
	this.m_restrictToColumns = restrictToColumns;
};
...
oFF.OlapApiModule.getInstance = function()
{
	if (oFF.isNull(oFF.OlapApiModule.s_module))
	{
		...
		oFF.CellFormattingScope.staticSetup();
