sap.ui.define([
        ...
        if (jqFocused) {
            ...
            if (isNotStackCardHeader && bNotExtendedBarListCard) {
                for (i = 0; i < labelledElement.length; i++) {
                    if (!labelledElement[i].id.includes(sCardHeader)) {
    ...
    /**
     * Method to handle page scroll when "up" arrow key is pressed.
     *
     * @method handleScrollUp
     */
    KeyboardNavigation.prototype.handleScrollUp = function () {
            ...
            if (oView) {
                setTimeout( function () {
                    ...
                    if (oScrollDelegate) {
                        ...
                        oScrollDelegate.scrollTo(0,fScrollPositon - fActiveCardTop - 32 /* card top-bottom padding and spacing*/);   
                    }
                    }, 0);
            }
        }
