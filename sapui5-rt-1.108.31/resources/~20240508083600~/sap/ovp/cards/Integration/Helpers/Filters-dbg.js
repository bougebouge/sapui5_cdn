sap.ui.define([
    ...
    */
    function getDateRangeValue(oValue, oParameter, bIsParameter, oGlobalFilter, aFilterLabel) {
    ...
    */
    function addDateRangeValueToSV(oCardDefinition, oProperty, sDefaultValue, oSelectionVariant, aFilterLabel) {
        ...
        if (bInsightRTEnabled) {
            var oDateRangeValue = getDateRangeValue(null, oProperty, false, oGlobalFilter, aFilterLabel);
