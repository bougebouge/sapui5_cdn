        ...
        mergeDatasets: function (binding, oDataClone, content) {
            ...
            if (bData && bData.results) {
                ...
                if (
                    ...
                    Object.keys(oColorPalette).length <= 10
                ) {
                            ...
                            var getColorRule = function (i, k, colorObject, key) {
                                return {
                                    callback: function (oContext) {
                                        if (
                                            (oContext && oContext[sDimensionLabel] === colorObject.dimensionValue) ||
                                    ...
                                    for (var k = 0; k < oDataClone.results.length; k++) {
                                        if (oDataClone.results[k][colorPaletteDimension] === colorObject.dimensionValue) {
                                            ...
                                            if (oCardModel && oCardModel.getProperty("/bInsightEnabled")) {
                                                var oRulesCopy = merge({}, oRule);
                                                delete oRulesCopy.callback;
                                                oRulesCopy.dataContext = {};
                                                oRulesCopy.dataContext[sDimensionLabel] = key;
                                                aDataPointStyleRulesCopy.push(oRulesCopy);
                                            }
                                        }
                                    }
                                });
                    ...
                    if (oCardModel && oCardModel.getProperty("/bInsightEnabled")) {
                        ...
                        var oVizPropertiesCopy = merge({}, oVizProps);
                        if (aDataPointStyleRulesCopy.length > 0) {
                            oVizPropertiesCopy.plotArea.dataPointStyle = {
                                "rules" :aDataPointStyleRulesCopy
                            };
                        }
