...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.renderers.fiori2.Shell", {
        ...
        onInit: function () {
            ...
            sap.ui.getCore().getEventBus().subscribe("ESHSearchFinished", this._logSearchActivity, this);
        ...
        onExit: function () {
            ...
            sap.ui.getCore().getEventBus().unsubscribe("ESHSearchFinished", this._logSearchActivity, this);
