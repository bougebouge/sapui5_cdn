                    ...
                    new SegmentedButtonItem("catalog", {
                        ...
                        customData: [
                            ...
                            new AccessibilityCustomData({
                                ...
                                value: oResourceBundle.getText("AppFinder.SegmentedButton.Catalog.Describedby"),
                                writeToDom: true
                            })
                        ]
                    })
            ...
            if (oController.bEnableEasyAccessUserMenu) {
                this.segmentedButton.addItem(new SegmentedButtonItem("userMenu", {
                    ...
                    customData: [
                        ...
                        new AccessibilityCustomData({
                            key: "aria-describedby",
                            value: oResourceBundle.getText("AppFinder.SegmentedButton.UserMenu.Describedby"),
                            writeToDom: true
                        })
                    ]
                }));
            ...
            if (oController.bEnableEasyAccessSAPMenu) {
                this.segmentedButton.addItem(new SegmentedButtonItem("sapMenu", {
                    ...
                    customData: [
                        ...
                        new AccessibilityCustomData({
                            key: "aria-describedby",
                            value: oResourceBundle.getText("AppFinder.SegmentedButton.SAPMenu.Describedby"),
                            writeToDom: true
                        })
                    ]
                }));
