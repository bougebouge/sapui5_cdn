 ...
 */
sap.ui.define(["sap/ui/fl/apply/_internal/DelegateMediator"],function(e){"use strict";var t={types:{READONLY:e.types.READONLY,WRITEONLY:e.types.WRITEONLY,COMPLETE:e.types.COMPLETE},registerDefaultDelegate:function(t){e.registerDefaultDelegate(t)},getDelegateForControl:function(t){return e.getDelegateForControl(t.control,t.modifier,t.modelType,t.supportsDefault)},getKnownDefaultDelegateLibraries:function(){return e.getKnownDefaultDelegateLibraries()},getRequiredLibrariesForDefaultDelegate:function(t){return e.getRequiredLibrariesForDefaultDelegate(t.delegateName,t.control,t.modelType)}};return t});
