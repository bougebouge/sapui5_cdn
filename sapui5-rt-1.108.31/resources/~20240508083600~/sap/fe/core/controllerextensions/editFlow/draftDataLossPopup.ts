 ...
 * @param navigationType The navigation type for which the function should be called
 */
async function processDraftAdminData(draftAdminData: any, fnProcessFunction: any,
    fnCancelFunction: any,
    oContext: any,
    oController: any,
    bSkipBindingToView?: boolean,
    ...
    if (draftAdminData) {
        if (oController.getAppComponent().getRootViewController().isFclEnabled()) {
            ...
            processEditingDraftForExistingEntity(
                oController,
                oContext,
                processFunctionForDrafts,
                navigationType,
...
async function processDataLossOrDraftDiscardConfirmation(
    ...
    if (
        ...
        try {
            ...
            await processDraftAdminData(draftAdminData,
                fnProcessFunction,
                fnCancelFunction,
                oContext,
                oController,
