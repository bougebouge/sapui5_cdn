...
sap.ui.define([
...
], function (assert, uniqueSort, uid, Format, library, TimeHorizon, Log, Core, TimezoneUtil) {
	"use strict";
	...
	Utility.getLowerCaseLabel = function(sLabel) {
		if (library.config.TIME_PATTERN_LOWERCASE) {
			var sLowerCaseLabel = sLabel.replaceAll("AM", "am");
			return sLowerCaseLabel.replaceAll("PM", "pm");
		} else {
			return sLabel;
		}
	};
