...
], function (ObjectPath, Core, Utility, Format, GanttUtils) {
			...
			if (largeIntervalTicks[0] !== null){
				for (iIndex = 0; iIndex < largeIntervalTicks.length; iIndex++){
					for (iInner = 0; iInner < largeIntervalTicks[iIndex].length; iInner++) {
						...
						label = Utility.getLowerCaseLabel(Utility.getFormattedDate(oUpperRowFormatter, date));
				...
				for (iIndex = 0; iIndex < smallIntervalTicks.length; iIndex++){
					for (iInner = 0; iInner < smallIntervalTicks[iIndex].length; iInner++) {
						...
						if (ignoreTickFlag){
							...
							sLargeLabel = Utility.getLowerCaseLabel(Utility.getFormattedDate(oUpperRowFormatter, changeDate));
							label = Utility.getLowerCaseLabel(Utility.getFormattedDate(oLowerRowFormatter, changeDate));
							changeDate = null;
						} else {
							sLargeLabel = Utility.getLowerCaseLabel(Utility.getFormattedDate(oUpperRowFormatter, date));
							label = Utility.getLowerCaseLabel(Utility.getFormattedDate(oLowerRowFormatter, date));
						}
				...
				for (iIndex = 0; iIndex < smallDstIntervalTicks.length; iIndex++){
					for (iInner = 0; iInner < smallDstIntervalTicks[iIndex].length; iInner++){
						...
						if (bIgnoreTickFlag){
							...
							label = Utility.getLowerCaseLabel(Utility.getFormattedDate(oLowerRowFormatter, oChangeDate));
							oChangeDate = null;
						} else {
