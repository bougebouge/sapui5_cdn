...
sap.ui.define([
	...
	ShapeInRow.prototype._textTruncate = function (oData, oSelf, nTruncateWidth, nEllipsisWidth, id) {
		...
		if (nTextLength > nTruncateWidth) { // truncate needed
			...
			if (bEllipsisAppear) {
				if (sap.ui.Device.browser.name === "cr" && sap.ui.Device.browser.version < 96){
					...
					//The above mentioned issue is reproducible only on Chrome versions which are below 96
					oSelf.append("tspan")
						.classed(id, true)
						.text("...")
