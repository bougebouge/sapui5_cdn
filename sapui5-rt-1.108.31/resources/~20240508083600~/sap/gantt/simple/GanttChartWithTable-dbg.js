	...
	GanttChartWithTable.prototype._getAllBindingPaths = function(oPathList, oTemplate, isExpandable) {
		...
		if (oAggregationList) {
			...
			for (var sAggregationName in oAggregationList) {
				...
				} else if (oAggregation.isA && oAggregation.isA("sap.gantt.simple.BaseShape") && !oAggregation.isA("sap.gantt.simple.UtilizationChart")) {
		...
		if (oAggregationList) {
			...
			for (var sAggregationName in oAggregationList) {
				...
				if (Array.isArray(oAggregation)) {
					...
					this._bTimeContinuousShapes = true;
					return;
				} else if (!this._bTimeContinuousShapes && oAggregation.isA && oAggregation.isA("sap.gantt.simple.BaseShape") && !oAggregation.isA("sap.gantt.simple.UtilizationChart")) {
	...
	GanttChartWithTable.prototype._getAllFormatters = function(oTemplate) {
		...
		if (oAggregationList) {
			for (var sAggregationName in oAggregationList) {
				...
				} else if (oAggregation.isA && oAggregation.isA("sap.gantt.simple.BaseShape")) {
