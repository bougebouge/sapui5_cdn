...
sap.ui.define(["jquery.sap.global",
	...
	function(jQuery, Element, ParsingBackendMediator, RuleServices, resourcesConvertor, RtsInitiator, responseCollector, Locale, LocaleData, vocabularyConstants) {
		 ...
		 */
		vocabularyConstants = vocabularyConstants;
		...
		ExpressionLanguage.prototype._initVocaRuntimeService = function() {
			...
			var runtimeServiceLib = RtsInitiator;
		...
		ExpressionLanguage.prototype._initBackendParser = function() {
			var backendParserLib = ParsingBackendMediator;
		...
		ExpressionLanguage.prototype._initResponseCollector = function(sSubject) {
			...
			var ResponseCollector = responseCollector.ResponseCollector;
		...
		ExpressionLanguage.prototype._fnValidateRule = function(oRule, flags) {
			...
			var result = RuleServices.validateRule(oConvertedRule, this._vocabularyName, this._runtimeService, flags);
		...
		ExpressionLanguage.prototype.getDecisionTableCellTokens = function(sHeaderExpression, sFixedOpr, sCellExpression,
			...
			var response = RuleServices.validateDecisionTableExpression(sHeaderExpression,
				sFixedOpr,
				sCellExpression,
				eExpressionType,
		...
		ExpressionLanguage.prototype._validateDecisionTableExpression = function(sHeaderExpression, sFixedOpr, sCellExpression, eExpressionType,
			...
			var result = RuleServices.validateDecisionTableExpression(sHeaderExpression, sFixedOpr, sCellExpression, eExpressionType, this._vocabularyName,
		...
		ExpressionLanguage.prototype.getExpressionLanguageVersion = function() {
			return RuleServices.getParserExprLangVersion();
		};
