...
], function(parsingBackendMediator, ruleBodyConstants, hrfException, ResponseCollector, utilsBaseLib,
		decisionTableCellLib) {
    "use strict";
    
	var parser = new parsingBackendMediator.parsingBackendMediatorLib();
