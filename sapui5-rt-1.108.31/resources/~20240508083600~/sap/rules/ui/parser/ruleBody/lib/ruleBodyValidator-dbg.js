sap.ui.define([
	"sap/rules/ui/parser/ruleBody/lib/ruleBody",
	"sap/rules/ui/parser/ruleBody/lib/constants",
	"sap/rules/ui/parser/businessLanguage/lib/constants",
	"sap/rules/ui/parser/resources/dependencies/lib/objects",
	"sap/rules/ui/parser/ruleBody/lib/dependenciesHandler",
	...
	"sap/rules/ui/parser/infrastructure/util/constants",
	"sap/rules/ui/parser/ruleBody/lib/decisionTableCell",
	"sap/rules/ui/parser/resources/dependencies/lib/constants"
], function(ruleBodyBase, ruleBodyConstants, RelConstants, dependenciesObjectsLib, dependenciesHandlerLib,
		vocConstants, ResponseCollectorLib, utilsBaseLib, utilConstantsLib, decisionTableCellLib, depConstants) {
    "use strict";
    
    var utilsLib = new utilsBaseLib.utilsBaseLib();
	var ResponseCollector = ResponseCollectorLib.ResponseCollector;
